...
% Some mobile-readiness better than none at all
% Not tested on different devices, but relying on framework to do its job, which it will probably do better than the less-than-experienced in responsive web design author.